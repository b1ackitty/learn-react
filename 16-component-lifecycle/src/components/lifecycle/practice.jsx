...
export default class Practice extends Component {
  ...
  componentDidMount() {
    ...
    console.log('문서 클릭 이벤트 연결 또는 구독')
    document.addEventListener('click', this.handleClick)
  }

  // 상태 업데이트 감지: 상태가 변경될 때마다 "변경된 상태 값" 출력
  componentDidUpdate(_, prevState) {
    console.log('변경되기 전 headline 상태 값', prevState.headline)
    console.log('변경된 headline 상태 값', this.state.headline)
  ...
  componentWillUnmount() {
    console.log('연결 또는 구독된 모든 이벤트 리스너 클린업(정리)')
