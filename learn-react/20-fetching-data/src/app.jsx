...
export default function App() {
  ...
  return (
    <LearnSection title="데이터 가져오기(Fetching Data)" showTitle>
      ...
      <div role="group" className="my-5 hidden">
      ...
      <div role="group" className="mt-5 hidden">
        <button
          type="button"
          className="button"
      ...
      <FetchingPostListDataDemo postId={postId} />
    </LearnSection>
  )
}
...
function FetchingPostListDataDemo({ postId }) {
...
// - 중단(Abort) 컨트롤러 활용
// - AbortController 클래스
// - AbortController 인스턴스 생성(예: const controller = new AbortController())
// - AbortController 인스턴스는 속성(controller.signal)과 메서드(controller.abort())
